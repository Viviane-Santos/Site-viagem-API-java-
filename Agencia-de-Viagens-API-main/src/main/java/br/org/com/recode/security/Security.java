...
public class Security extends WebSecurityConfigurerAdapter {
   ...
   // CONFIG DE AUTORIZAÇÂO
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests().antMatchers(HttpMethod.POST, "/auth").permitAll()
                .antMatchers(HttpMethod.POST, "/cadastrar").permitAll().anyRequest().authenticated().and()
